# Generated by Powerlevel10k configuration wizard on 2026-09-01 at 14:45 CEST.
...
() {
  ...
  # - local   `asdf current` says "set by /some/other/directory/file"
  # - global  `asdf current` says "set by /home/<user>/file"
  #
  ...
  #     '*'           DEFAULT)
  #
  # If your current Google application credentials is "service_account deathray-testing <user>@<domain>",
